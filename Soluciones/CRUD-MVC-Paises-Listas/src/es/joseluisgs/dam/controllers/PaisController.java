...
public class PaisController {
    ...
    private void initRepositoryData() {
        this.paisRepository.encolar(new Pais("España", "ES", "Castellano", "Euro", "Madrid"));
        this.paisRepository.encolar(new Pais("Francia", "FR", "Francés", "Euro", "Paris"));
        this.paisRepository.encolar(new Pais("Italia", "IT", "Italiano", "Euro", "Roma"));
        this.paisRepository.encolar(new Pais("Alemania", "DE", "Alemán", "Euro", "Berlín"));
        this.paisRepository.encolar(new Pais("Reino Unido", "UK", "Inglés", "Libra", "Londres"));
        this.paisRepository.encolar(new Pais("Japón", "JP", "Japonés", "Yen", "Tokio"));
        this.paisRepository.encolar(new Pais("China", "CN", "Chino", "Yuan", "Pekín"));
        this.paisRepository.encolar(new Pais("Australia", "AU", "Inglés", "Dólar", "Canberra"));
        this.paisRepository.encolar(new Pais("Argentina", "AR", "Español", "Peso", "Buenos Aires"));
        this.paisRepository.encolar(new Pais("Brasil", "BR", "Portugués", "Real", "Brasilia"));
        this.paisRepository.encolar(new Pais("Estados Unidos", "US", "Inglés", "Dólar", "Washington"));
    }
    ...
    public Pais updatePais(Pais pais) throws PaisException {
